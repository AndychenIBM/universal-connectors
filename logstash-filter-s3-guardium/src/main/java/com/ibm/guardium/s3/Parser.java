...
public class Parser {
    ...
    public static String DELETE_BUCKET_EVENT = "{ \"eventVersion\": \"1.05\", \"userIdentity\": { \"type\": \"IAMUser\", \"principalId\": \"AIDAJWW2XAIOY2WN3KAAM\", \"arn\": \"arn:aws:iam::987076625343:user/ProxyTest\", \"accountId\": \"987076625343\", \"accessKeyId\": \"ASIA6LUS2AO77R57V5HJ\", \"userName\": \"ProxyTest\", \"sessionContext\": { \"attributes\": { \"mfaAuthenticated\": \"false\", \"creationDate\": \"2020-07-07T07:37:14Z\" } } }, \"eventTime\": \"2020-07-07T07:39:25Z\", \"eventSource\": \"s3.amazonaws.com\", \"eventName\": \"DeleteBucket\", \"awsRegion\": \"us-east-1\", \"sourceIPAddress\": \"89.138.37.139\", \"userAgent\": \"[S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.783 Linux/4.9.217-0.1.ac.205.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.252-b09 java/1.8.0_252 vendor/Oracle_Corporation]\", \"errorCode\": \"BucketNotEmpty\", \"errorMessage\": \"The bucket you tried to delete is not empty\", \"requestParameters\": { \"host\": [ \"s3.amazonaws.com\" ], \"bucketName\": \"tmpbuckettodelete\" }, \"responseElements\": null, \"additionalEventData\": { \"SignatureVersion\": \"SigV4\", \"CipherSuite\": \"ECDHE-RSA-AES128-SHA\", \"AuthenticationMethod\": \"AuthHeader\", \"vpcEndpointId\": \"vpce-f40dc59d\" }, \"requestID\": \"B3857E6B2F801F66\", \"eventID\": \"cd01b024-269c-4030-9bbd-43886b22a822\", \"eventType\": \"AwsApiCall\", \"recipientAccountId\": \"987076625343\", \"vpcEndpointId\": \"vpce-f40dc59d\" }";
    public static String CREATE_BUCKET_EVENT = "";
    ...
    public static Record buildRecord(final JsonObject eventData) throws ParseException {
        ...
        log.debug("S3 sessionId is "+userIdentity.toString());
        ...
        String resourcesStr = getValue(eventData, "resources");
        try {
...
//            JsonObject inputJSON = (JsonObject) JsonParser.parseString(GETOBJECT_EVENT);
            JsonObject inputJSON = (JsonObject) JsonParser.parseString(DELETE_BUCKET_EVENT);
