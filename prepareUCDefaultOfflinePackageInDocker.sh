...
../bin/logstash-plugin install logstash-filter-logstash_filter_s3_guardium-0.5.4.gem
...
../bin/logstash-plugin install logstash-input-mongo_atlas_input-1.0.1.gem
../bin/logstash-plugin prepare-offline-pack --output ./guardium_logstash-offline-plugins.zip --overwrite logstash-filter-logstash_filter_s3_guardium logstash-filter-mysql_filter_guardium logstash-filter-mongodb_guardium_filter logstash-input-cloudwatch_logs logstash-input-mongo_atlas_input
../bin/logstash-plugin list --verbose
