...
_GUC_UC_LOG_LEVEL=error _GUC_PERSISTENT_QUEUE_SIZE=512mb _GUC_PIPELINE_CONFIG_PATH=/service/guc-config/TNT_7J7BDDBGQDUOYGQ5WQ3WXJ/curConfig.conf _GUC_PERSISTENT_QUEUE_TYPE=persisted _TENANT_ID=TNT_7J7BDDBGQDUOYGQ5WQ3WXJ TENANT_ID=TNT_7J7BDDBGQDUOYGQ5WQ3WXJ _MINI_SNIF_HOSTNAME=mini-snif ./start.sh v1/universal-connector.lst
...
docker run -d --name="mongo_fb" -e FILEBEAT_HOSTS="universal-connector:5044" --link universal-connector:universal-connector -it mongo_filebeat_ubi bash
